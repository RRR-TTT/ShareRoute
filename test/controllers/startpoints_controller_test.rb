...
class StartpointsControllerTest < ActionController::TestCase
  ...
  test "should create startpoint" do
    assert_difference('Startpoint.count') do
      post :create, startpoint: { StartpointName: @startpoint.StartpointName, StartpointSpendTime: @startpoint.StartpointSpendTime }
    end
  ...
  test "should update startpoint" do
    patch :update, id: @startpoint, startpoint: { StartpointName: @startpoint.StartpointName, StartpointSpendTime: @startpoint.StartpointSpendTime }
    assert_redirected_to startpoint_path(assigns(:startpoint))
  end
