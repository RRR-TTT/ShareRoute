...
class ExplanationsControllerTest < ActionController::TestCase
  ...
  test "should create explanation" do
    assert_difference('Explanation.count') do
      post :create, explanation: { ExplanationContent: @explanation.ExplanationContent, LastUpdate: @explanation.LastUpdate, UpdatedUser_id: @explanation.UpdatedUser_id }
    end
  ...
  test "should update explanation" do
    patch :update, id: @explanation, explanation: { ExplanationContent: @explanation.ExplanationContent, LastUpdate: @explanation.LastUpdate, UpdatedUser_id: @explanation.UpdatedUser_id }
    assert_redirected_to explanation_path(assigns(:explanation))
  end
